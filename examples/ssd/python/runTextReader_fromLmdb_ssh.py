...
coco_labelmap_file = '/home/marissac/ssd/caffe/data/coco/labelmap_coco_combo.prototxt'
...
model_def = '/home/marissac/ssd/caffe/examples/ssd/models/VGGNet/cocoText/SSD_300x300/test_multiclass_ssh.prototxt'
model_weights = '/home/marissac/ssd/caffe/examples/ssd/models/VGGNet/cocoText/SSD_300x300/VGG_cocoText_SSD_300x300_iter_204000.caffemodel'
...
lmdb_env = lmdb.open('/home/marissac/data/coco/coco_combo_val2014_final_lmdb')
...
for img_idx in range(imgStart,imgStart+numImgTest):
    ...
    if img_idx % 10000 == 0:
        with open('/home/marissac/data/cocoText/instances/detection_cocoText_anns_' + repr(imgStart+img_idx) + '_legible.pickle','wb') as f:
            pickle.dump(anns,f)
    
        with open('/home/marissac/data/cocoText/instances/detection_cocoText_imgToAnns_' + repr(imgStart+img_idx) + '_legible.pickle','wb') as f:
            pickle.dump(imgToAnns,f)

with open('/home/marissac/data/cocoText/instances/detection_cocoText_anns_' + repr(imgStart+numImgTest) + '_legible.pickle','wb') as f:
    pickle.dump(anns,f)
    
with open('/home/marissac/data/cocoText/instances/detection_cocoText_imgToAnns_' + repr(imgStart+numImgTest) + '_legible.pickle','wb') as f:
    pickle.dump(imgToAnns,f)
