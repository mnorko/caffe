...
model_name = "VGG_cocoText_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/cocoText/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/cocoText/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/cocoText/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/cocoText/results/{}/Main".format(os.environ['HOME'], job_name)
...
name_size_file = "data/coco/cocotext_val_name_size.txt"
...
det_out_param = {
    ...
    'save_output_param': {
        ...
        'output_name_prefix': "instances_train2014_bbox_results",
        'output_format': "COCO",
