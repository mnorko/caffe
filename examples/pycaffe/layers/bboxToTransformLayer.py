...
class BboxToTransformLayer(caffe.Layer):
    ...
    def forward(self,bottom,top):
        ...
        top: [0] - theta [num_batch_used*max_matches x 6]
             ...
             [2] - gt labels for text reader [num_batch_used8max_matches x 23]
        bottom: [0] - pred_bbox - bounding boxes for each image [num_batch_used x 4 x max_matches x 1]
                [1] - gt_word_labels - contains ground truth information about bbox and the words - sent to word reader part of the net [num_batch_used*max_matches x 31]
