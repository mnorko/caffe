...
class SpatialTransformerFastLayer(caffe.Layer):
    ...
    def forward(self,bottom,top):
        ...
        bottom: [0] - input image or convolutional outputs
                [1] - theta [num_batch,6] - [theta_1_1,theta_1_2,theta_1_3, theta_2_1, theta_2_2, theta_2_3]
        """
        theta = bottom[1].data
        img = bottom[0].data
        ...
        #print x_s_flat
        #print y_s_flat
        top[0].data[...] = interpolate(img, x_s_flat,y_s_flat,out_size)
...
def interpolate(img,x,y,out_size):
    """
    ...
    for k in range(0,N):
        ...
        img_batch = np.reshape(img[k,:,:,:],[C,-1])
