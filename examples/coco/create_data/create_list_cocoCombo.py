...
train_list_file = "{}/combo_legible_train2014_final.txt".format(CURDIR)
val_list_file = "{}/combo_legible_val2014_final.txt".format(CURDIR)

# Create training set.
# We follow Ross Girschick's split.
if redo or not os.path.exists(train_list_file):
    datasets = ["combo_legible_train2014"]
    subset = "train2014"
    img_files = []
    anno_files = []
...
if redo or not os.path.exists(train_list_file):
    datasets = ["combo_legible_val2014"]
    subset = "train2014"
    img_files = []
    anno_files = []
    for dataset in datasets:
